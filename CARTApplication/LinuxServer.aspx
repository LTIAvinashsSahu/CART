<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CARTMasterPage.Master" ValidateRequest="false" Title="Linux Server" CodeBehind="LinuxServer.aspx.cs" Inherits="CARTApplication.LinuxServer" %>
...
<td style="font-weight: bold; text-decoration: underline">Linux Server Mapping</td>
</tr>
  </table>
...
<td style="width:100%; height: 20%;" align="left" valign=top>
       ...
       <SelectedRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
        ...
        <%-- <asp:TemplateField HeaderText="RowID" Visible=false>
            ...
            <asp:TemplateField HeaderText="ServerID" Visible=false>
                <ItemTemplate>
                    <asp:Label ID="lblShareID" runat="server" Text='<%# Bind("Serverid")%>' />
                </ItemTemplate>
            </asp:TemplateField>
  ...
  <ItemStyle HorizontalAlign="Center" />
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="tbGridServerName" Width="100%" runat="server"  ></asp:TextBox>
