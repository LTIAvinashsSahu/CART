...
{
    public partial class ShareList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            btnAddApp.Attributes.Add("onclick", "window.open('ApplicationDetail.aspx?Nav=ShMapp&app='+ '" + blnapp + "',null,'scrollbars=1;width=800px; height=800px;');");
            ...
            btnAddServer.Attributes.Add("onclick", "window.open('ServerList.aspx?Nav=ShMapp&server=' + '" + blnserver + "', null,'scrollbars=1;width=800px; height=600px;');");
        ...
        protected void gvShare_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                //DeleteShare(ShareID);
                lblSuccess.Text = "Share deleted sucessfully.";
                PopulateGrid();
            }
            catch (NullReferenceException)
            {
        ...
        protected void gvShare_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            try
            {
                ...
                TextBox txtGridShareName = (TextBox)gvShare.Rows[e.RowIndex].FindControl("txtGridShareName");
                string strShareName = txtGridShareName.Text.ToString().Trim();
                    ...
                    if (ddlGridServerName.SelectedIndex != 0)
                    {
                        if (ddlGridAppName.SelectedIndex != 0)
                        {
                            ...
                            if (!blnShareExists)
                            {
                                ...
                                //}
                                //comment ends
                                bool bln = objclsBALMasterData.SaveShare(strShareName, intServerID);
                                int intShareID = objclsBALMasterData.GetShareID(strShareName);
                                SaveApplicationMapping(intAppID, intShareID);
                                DeleteMapping(AppID, ShareID);
                                lblSuccess.Text = "Share saved successfully.";
                            }
                            else
                            {
                                //code commented on 21 Jul
                                ...
                                //else
                                //{
                                //    lblError.Text = "Server mapping for the share already exists.";
                                //}
        ...
        protected void gvShare_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    Label lblShareName = (Label)e.Row.FindControl("lblShareName");
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                lblError.Text = "Please fill share name.";
        ...
        private void ExportGridView(GridView gdExport)
        {
            ...
            objExp.ExportGridView(gdExport, "Share");
