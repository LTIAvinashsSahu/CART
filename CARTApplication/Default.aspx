<%@ Page Language="C#" MasterPageFile="~/CARTMasterPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CARTApplication._Default"  Title="Home" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="50%" class="text_blue_hd">
                                        ...
                                        <asp:Label ID="lblAnnounce" runat="server" Text-align="left"
                                            Text=" CART is an automated workflow designed to streamline the periodic user access review process."></asp:Label>
                            ...
                            <table width="100%">
                                <tr>
                                    <td width="15%">
                                     ...
                                     <asp:Label ID="lblLockout" Width="15%" style="background-color:yellow" Text="Lock CART" Visible="False" runat="server" CssClass="text_blue_mid"></asp:Label>
