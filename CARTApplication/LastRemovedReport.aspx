<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CARTMasterPage.Master" Title="To be Removed Report" CodeBehind="LastRemovedReport.aspx.cs" Inherits="CARTApplication.LastRemovedReport" %>
...
<td><font style="font-size:small; font-weight:bold; text-decoration:underline">To be Removed</font> </td>
    ...
    <table width="100%" align="center">
        <tr>
            ...
            <table width="70%">
                 <tr>
                    <td class="SmallHeading" align="center" id="td2" runat="server" valign="top">
                         <asp:Label ID="lblPeriod" runat="server" Text="Select Quarter:"></asp:Label>
                         <asp:DropDownList ID="ddlQuarter" runat="server" Width="130px">
                         </asp:DropDownList>
                    </td>
                    <td class="SmallHeading" align="center" id="td1" runat="server" valign="top">
                         Report Type:
                            ...
                            <tr>
                                <td align="center">
                                  ...
                                  <asp:View ID="View1" runat="server"> 
                                    <asp:GridView ID="gvShare" runat="server" AllowSorting="True" AutoGenerateColumns="false"
                                        CssClass="dataGrid"> 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="AD ID">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDatabasename" runat="server" Text='<%# Bind("[AD ID]")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
