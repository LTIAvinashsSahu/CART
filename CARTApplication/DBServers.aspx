<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CARTMasterPage.Master" ValidateRequest="false" Title="Database Server List" CodeBehind="DBServers.aspx.cs" Inherits="CARTApplication.DBServers" %>
...
<td style="width:100%; height: 20%;" align="left" valign=top>
    ...
    <tr>
     ...
     <tr>
         <td style="width: 100%" valign="top">
             <table width="100%" cellspacing="0px" cellpadding="0px">
                 ...
                 <tr>
                      <td class="SmallHeading" style="width: 30%" align="center">
                         Server Name:
                     </td>
                 ...
                 <tr>
                    <td class="SmallHeading" style="width: 30%" align="center">
                      ...
                      <td align="left" width="40%">
                         <asp:DropDownList ID="ddlDBServerType" runat="server">
                         </asp:DropDownList>
                     </td>
                 </tr>
     ...
     <asp:GridView ID="gvServer" runat="server" Width="80%" AutoGenerateColumns="False" CssClass="datagrid" 
              ...
              OnRowDeleting="gvServer_RowDeleting" AllowPaging="True"
       ...
       <SelectedRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
        ...
        <Columns>
            <asp:TemplateField HeaderText="ServerID" Visible=false>
                <ItemTemplate>
                    <asp:Label ID="lblServerID" runat="server" Text='<%# Bind("serverID")%>' />
                     <asp:Label ID="lblServertype_id" runat="server" Text='<%# Bind("servertype_id")%>' />
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Server Name" SortExpression="ServerName" >
             ...
             <asp:TemplateField HeaderText="Server Type" SortExpression="ServerType" >
                <ItemTemplate>
                    <asp:Label ID="lblServerType"   runat="server" Text='<%# Bind("serverType")%>' />
                </ItemTemplate>
                <EditItemTemplate>
                    <%--<asp:DropDownList ID="ddlGridServerType" Width="100%" runat="server" Text='<%# Bind("serverType")%>' />--%>
                    <asp:DropDownList ID="ddlGridServerType" Width="100%" runat="server" />
                    <asp:Label ID="lblGridServerTypeHdn" Visible="false" runat="server" Text='<%# Bind("serverType")%>' />
                </EditItemTemplate>
            </asp:TemplateField>
