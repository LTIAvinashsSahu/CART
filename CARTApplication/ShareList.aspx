<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CARTMasterPage.Master" ValidateRequest="false" Title="Share List" CodeBehind="ShareList.aspx.cs" Inherits="CARTApplication.ShareList" %>
...
<td><font style="font-size:small; font-weight:bold; text-decoration:underline">Share List</font> </td>
</tr>
  </table>
...
<td style="width:100%; height: 20%;" align="left" valign=top>
     ...
     <tr>
         <td style="width: 100%" valign="top">
             <table width="100%" cellspacing="0px" cellpadding="0px">
                 ...
                 <tr>
                    <td align="center">
     <asp:GridView ID="gvShare" runat="server" Width="80%" AutoGenerateColumns="False" CssClass="datagrid" 
              OnRowEditing="gvShare_RowEditing" OnRowUpdating="gvShare_RowUpdating" OnRowCancelingEdit="gvShare_RowCancelingEdit" 
              OnRowDeleting="gvShare_RowDeleting" AllowPaging="True" PageSize="50" 
              onrowdatabound="gvShare_RowDataBound" AllowSorting="True" 
                            onpageindexchanging="gvShare_PageIndexChanging" 
                            onrowcreated="gvShare_RowCreated" onsorting="gvShare_Sorting" >
       <SelectedRowStyle BackColor="#738A9C" Font-Bold="True" ForeColor="White" />
        ...
        <Columns>
         <asp:TemplateField HeaderText="RowID" Visible=false>
            ...
            <asp:TemplateField HeaderText="Share Name" SortExpression="ShareName">
            <ItemStyle HorizontalAlign="Center" />
                <ItemTemplate>
                    <asp:Label ID="lblShareName" runat="server" Text='<%# Bind("ShareName")%>' />
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox ID="txtGridShareName" Width="100%" runat="server" Text='<%# Bind("ShareName")%>' />
                    <asp:Label ID="lblGridShareHdn" Visible="false" runat="server" Text='<%# Bind("ShareName")%>' />
                </EditItemTemplate>
            </asp:TemplateField>
  ...
  <ItemStyle HorizontalAlign="Center" />
                ...
                <EditItemTemplate>
                    ...
                    <asp:Label ID="lblGridServerNameHdn" Visible="false" runat="server" Text='<%# Bind("ServerName")%>' />
                </EditItemTemplate>
            </asp:TemplateField>
